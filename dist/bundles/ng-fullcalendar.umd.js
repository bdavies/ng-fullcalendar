(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('jquery')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'jquery'], factory) :
...
})(typeof self !== 'undefined' ? self : undefined, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_15__) {
...
var ResourceViewMixin = /** @class */ (function (_super) {
    ...
    ResourceViewMixin.prototype.queryScroll = function () {
        ...
        if (this.isResourcesRendered) {
            $$$1.extend(scroll, this.queryResourceScroll());
        }
        return scroll;
    };
...
var TimelineView = /** @class */ (function (_super) {
    ...
    */
    ...
    TimelineView.prototype.renderSkeleton = function () {
        ...
        this.slatContainerEl = $$$1('<div class="fc-slats"/>').appendTo(this.timeBodyScroller.canvas.bgEl);
        this.segContainerEl = $$$1('<div class="fc-event-container"/>').appendTo(this.timeBodyScroller.canvas.contentEl);
    ...
    TimelineView.prototype.renderNowIndicator = function (date) {
        ...
        if (this.normalizedUnzonedRange.containsDate(date)) {
            ...
            var css = this.isRTL ?
                { right: -coord } :
                { left: coord };
            nodes.push($$$1("<div class='fc-now-indicator fc-now-indicator-arrow'></div>")
                .css(css)
                .appendTo(this.timeHeadScroller.canvas.el)[0]);
            nodes.push($$$1("<div class='fc-now-indicator fc-now-indicator-line'></div>")
                .css(css)
                .appendTo(this.timeBodyScroller.canvas.el)[0]);
        }
        this.nowIndicatorEls = $$$1(nodes);
    };
    // will only execute if isTimeScale
    ...
    TimelineView.prototype.computeSlotWidth = function () {
        ...
        innerEls.each(function (i, node) {
            var innerWidth = $$$1(node).outerWidth();
...
var RowParent = /** @class */ (function (_super) {
    ...
    */
    RowParent.prototype.getMaxTrInnerHeight = function () {
        var max = 0;
        $$$1.each(this.trHash, function (type, tr) {
...
var ClippedScroller = /** @class */ (function (_super) {
    ...
    */
    ...
    ClippedScroller.prototype.renderEl = function () {
        ...
        return $$$1('<div class="fc-scroller-clip" />').append(scrollEl); // return value
    };
...
var ScrollerCanvas = /** @class */ (function () {
    ...
    ScrollerCanvas.prototype.render = function () {
        this.el = $$$1("<div class=\"fc-scroller-canvas\"> <div class=\"fc-content\"></div> <div class=\"fc-bg\"></div> </div>");
    ...
    */
    ScrollFollower.prototype.setSpriteEls = function (els) {
        ...
        els.each(function (i, node) {
            _this.addSprite(new ScrollFollowerSprite_1.default($$$1(node)));
        });
    };
    ...
    */
    TimelineFillRenderer.prototype.attachSegEls = function (type, segs) {
        if (segs.length) {
            ...
            var containerEl = $$$1('<div class="fc-' + className + '-container" />')
...
var TimelineHelperRenderer = /** @class */ (function (_super) {
    ...
    */
    TimelineHelperRenderer.prototype.renderSegs = function (segs, sourceSeg) {
        ...
        var helperContainerEl = $$$1('<div class="fc-event-container fc-helper-container"/>')
        ...
        return $$$1(helperNodes); // return value. TODO: need to accumulate across calls?
    };
...
var ResourceTimelineView = /** @class */ (function (_super) {
    ...
    ResourceTimelineView.prototype.renderSkeleton = function () {
        ...
        var timeBodyContainerEl = $$$1("<div class=\"fc-rows\"> <table class=\"" + theme.getClass('tableGrid') + "\"> <tbody/> </table> </div>").appendTo(this.timeBodyScroller.canvas.contentEl);
    ...
    */
    VRowGroup.prototype.renderRowspan = function () {
        ...
        if (this.rowspan) { // takes up at least one row?
            ...
            if (!this.groupTd) {
                this.groupTd = $$$1('<td class="' + theme.getClass('widgetContent') + '"/>')
...
var RowGroup = /** @class */ (function (_super) {
    ...
    */
    RowGroup.prototype.renderGroupContentEl = function () {
        var contentEl = $$$1('<div class="fc-cell-content" />')
    ...
    */
    RowGroup.prototype.renderGroupTextEl = function () {
        ...
        return $$$1('<span class="fc-cell-text" />').text(text);
    };
    return RowGroup;
}(RowParent_1.default));
...
function detectRtlScrollSystem() {
    var el = $$$1("<div style=\" position: absolute; top: -1000px; width: 1px; height: 1px; overflow: scroll; direction: rtl; font-size: 100px; \">A</div>").appendTo('body');
    var node = el[0];
    var system = (function () {
...
var Spreadsheet = /** @class */ (function () {
    ...
    Spreadsheet.prototype.queryColWidths = function () {
        return this.headCellEls.map(function (i, node) { return ($$$1(node).outerWidth()); }).get();
    };
    // Sizing
    // ---------------------------------------------------------------------------------
    ...
    Spreadsheet.prototype.updateCellFollower = function () {
        ...
        this.cellFollower.setSpriteEls($$$1(nodes));
    ...
    */
    ResourceRow.prototype.renderSpreadsheetSkeleton = function (tr) {
        ...
        for (var _i = 0, _a = this.view.colSpecs; _i < _a.length; _i++) {
            ...
            var td = $$$1('<td class="' + theme.getClass('widgetContent') + '"/>')
                .append(contentEl);
    ...
    */
    HRowGroup.prototype.renderSpreadsheetSkeleton = function (tr) {
        ...
        contentEl.prepend('<span class="fc-expander">' +
            '<span class="fc-icon"></span>' +
            '</span>');
        return $$$1('<td class="fc-divider" />')
            .attr('colspan', this.view.colSpecs.length) // span across all columns
            .append($$$1('<div/>').append(contentEl) // needed by setTrInnerHeight
        )
            .appendTo(tr);
    };
    /*
...
fullcalendar_1.Calendar.prototype.getResourceEvents = function (idOrResource) {
    ...
    if (resource) {
        ...
        return this.clientEvents(function (event) {
            return $$$1.inArray(resource.id, _this.getEventResourceIds(event)) !== -1;
        });
    }
    else {
        return [];
...
var ResourceManager = /** @class */ (function (_super) {
    ...
    */
    ResourceManager.prototype.fetchResourceInputs = function (callback, start, end) {
        ...
        if ($$$1.type(source) === 'string') {
            source = { url: source };
        }
        switch ($$$1.type(source)) {
            case 'function':
            ...
            case 'object':
                ...
                $$$1.ajax(// TODO: handle failure
                $$$1.extend({ data: requestParams }, ResourceManager.ajaxDefaults, source)).then(function (resourceInputs) {
                    calendar.popLoading();
                    callback(resourceInputs);
                });
                break;
    ...
    ResourceManager.prototype.buildResource = function (resourceInput) {
        var _this = this;
        var resource = $$$1.extend({}, resourceInput);
...
fullcalendar_1.Constraints.prototype.isFootprintAllowed = function (footprint, peerEventFootprints, constraintVal, overlapVal, subjectEventInstance) {
    if (typeof constraintVal === 'object') {
        ...
        if (constrainToResourceIds.length && (!(footprint instanceof ResourceComponentFootprint_1.default) ||
            $$$1.inArray(footprint.resourceId, constrainToResourceIds) === -1)) {
            return false;
        }
    }
...
function isValidKey(key) {
    if ($$$1.inArray(key, PRESET_LICENSE_KEYS) !== -1) {
        return true;
    }
...
function renderingWarningInContainer(messageHtml, containerEl) {
    return containerEl.append($$$1('<div class="fc-license-message" />').html(messageHtml));
}
...
fullcalendar_1.EventDef.prototype.applyMiscProps = function (rawProps) {
    rawProps = $$$1.extend({}, rawProps); // clone, because of delete
...
fullcalendar_1.EventDef.prototype.hasResourceId = function (resourceId) {
    return $$$1.inArray(resourceId, this.resourceIds) !== -1;
};
/*
resourceId should already be normalized
*/
